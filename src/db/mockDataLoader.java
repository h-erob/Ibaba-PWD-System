...
public class mockDataLoader {
    public static void loadMockData(Connection conn) {
        try {
            ...
            if (!file.exists()) {
                System.out.println("⚠️ No mock SQL file found. Skipping mock data.");
                return;
            }
            ...
            if (memberCount > 0) {
                System.out.println("⚠️ Members table already contains data. Skipping mock data to prevent conflicts.");
                return;
            }

            // Check if admins table has data (optional, if you want to preserve admin data)
            ...
            while (scanner.hasNext()) {
                ...
                // Skip admin inserts if admins table is populated
                ...
                try {
                    ...
                    System.out.println("⚠️ Error executing SQL: " + sql);
                    ex.printStackTrace();
                }
            }
